<aside class="flex flex-col w-72 bg-[var(--bg-light-gray)] shadow-lg min-h-screen p-6 z-20">
    <div class="ml-4">
        ...
        <nav class="space-y-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('studyData.index') }}" class="text-lg font-medium hover:text-[var(--accent-yellow)]">学習データ</a>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('question.index') }}" class="text-lg font-medium hover:text-[var(--accent-yellow)]">質問ひろば</a>
            </div>
        </nav>
    </div>
</aside>
